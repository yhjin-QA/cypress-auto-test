...
describe('로그캐치 Depth 배포점검목록 동작 테스트', () => {
  ...
  it('04_Depth_소명_사후소명_신청취소 자동화 시나리오', () => {
...
// ==========================================================
// STEP: 소명하기 조건(취소)& 소명유형(사후소명) 조건 설정후 검색하기 
// ==========================================================
// 선택되어있는거 지우기 x버튼클릭 -  초기화코드
cy.get('i.material-icons').contains('clear').click({ force: true });
cy.wait(1000);
