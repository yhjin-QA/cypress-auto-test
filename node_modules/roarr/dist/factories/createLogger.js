...
const createChildLogger = (log, logLevel) => {
    return (a, b, c, d, e, f, g, h, index, index_) => {
        if (typeof a === 'string') {
            ...
            log({ logLevel }, a, b, c, d, e, f, g, h, index);
        }
        else {
            // Context + message call: merge logLevel into existing context
            log({ ...a, logLevel }, b, c, d, e, f, g, h, index, index_);
        }
    };
};
const MAX_ONCE_ENTRIES = 1000;
const buildOnceKey = (logLevel, a, b) => {
...
const createLogger = (onMessage, parentMessageContext = {}, transforms = []) => {
    ...
    const log = (a, b, c, d, e, f, g, h, index, index_) => {
        ...
        const asyncLocalContext = (_a = asyncLocalStorage === null || asyncLocalStorage === void 0 ? void 0 : asyncLocalStorage.getStore()) !== null && _a !== void 0 ? _a : createDefaultAsyncLocalContext();
        // Generate sequence inline using cached references
        let sequence;
        if ('sequenceRoot' in asyncLocalContext &&
            typeof asyncLocalContext.sequence === 'number') {
            sequence =
